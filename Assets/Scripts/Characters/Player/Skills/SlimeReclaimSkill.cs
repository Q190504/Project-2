...
public class SlimeReclaimSkill : BaseSkill
{
    ...
    {
        bool hasWaitingSlimeBullet = ProjectilesManager.Instance.HasSlimeBulletsToReclaim();
    ...
    private void RecallBullets()
    {
        ...
        List<SlimeBullet> activeBullets = ProjectilesManager.Instance.GetSlimeBulletsWaitToReclaim();
